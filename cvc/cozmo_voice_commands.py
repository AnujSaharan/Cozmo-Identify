...
###### VARS ######
version = "Version 1"
title = "Cozmo Voice Commands Central" + version
author ="Anuj Saharan"
log = False
wait_for_shift = False
lang = None
lang_data = None
commands_activate = ["jerry", "cozmo", "robot", "cosmo", "cosimo", "cosma", "cosima", "kosmos", "cosmos", "cosmic", "osmo", "kosovo", "peau", "kosmo", "kozmo", "gizmo", "瓦力", "小不点"]
vc = None
languages = []
